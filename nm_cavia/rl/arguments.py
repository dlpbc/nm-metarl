...
def parse_args():
    ...
    # Run neuromodulated version of policy (either CAVIA or MAML)
    parser.add_argument('--neuromodulation', action='store_true', default=False,
                        help='turn on neuromodulation in policy')
    parser.add_argument('--nm-size', type=int, default=10,
                        help='number of neuromodulation units per layer')
    parser.add_argument('--nm-gate', type=str, default='hard',
                        help='`hard` or `soft` gating via neuromodulation')
    ...
    parser.add_argument('--nonlinearity', type=str, default='relu',
                        help='nonlinearity/activation of hidden layers')
    ...
    parser.add_argument('--expname', type=str, default='', help='unique name of experiment run')
